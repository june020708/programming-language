...
public class Sint {
    ...
    Value binaryOperation(Operator op, Value v1, Value v2) { // Lab03
        ...
        case "/": 
            return new Value(v1.intValue() / v2.intValue());
        case "==":
            if(v1.type() == Type.INT) return new Value(v1.intValue() == v2.intValue());
            if(v1.type() == Type.BOOL) return new Value(v1.boolValue() == v2.boolValue());
            if(v1.type() == Type.STRING) return new Value(v1.stringValue().equals(v2.stringValue()));
        case "!=":
            if(v1.type() == Type.INT) return new Value(v1.intValue() != v2.intValue());
            if(v1.type() == Type.BOOL) return new Value(v1.boolValue() != v2.boolValue());
            if(v1.type() == Type.STRING) return new Value(!v1.stringValue().equals(v2.stringValue()));
        case "<":
            if(v1.type() == Type.INT) return new Value(v1.intValue() < v2.intValue());
            if(v1.type() == Type.STRING) return new Value(v1.stringValue().compareTo(v2.stringValue()) < 0);
        case "<=":
            if(v1.type() == Type.INT) return new Value(v1.intValue() <= v2.intValue());
            if(v1.type() == Type.STRING) return new Value(v1.stringValue().compareTo(v2.stringValue()) <= 0);
        case ">":
